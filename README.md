...
- Mobile Testing - QAFox (курс на youtube).
  > (Виды и типы приложений и устройств, платформы ОС, ориентация и жесты, Android SDK(эмулятор), iOS Simulator(симулятор), типы тестирования, автоматизация и инструменты: Google Chrome, Screenfly, GenyMotion, Kobitone)
